...
Il frontend di [Pistakio gelato](https://pistakiogelato.com) è sviluppato separatamente dal [backend](https://github.com/kevindonati/PistakioGelatoBE) ed è responsabile dell'interfaccia utente dell'e-commerce.
